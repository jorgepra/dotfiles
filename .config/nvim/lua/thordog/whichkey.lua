...
local m_mappings = {
  ...
  --l = { "<cmd>lua require('thordog.bfs').open()<cr>", "Buffers" },
...
local mappings = {
  ...
  q = { '<cmd>lua require("thordog.functions").smart_quit()<CR>', "Quit" },
  ...
  o = {
    ...
    w = { '<cmd>lua require("thordog.functions").toggle_option("wrap")<cr>', "Wrap" },
    r = { '<cmd>lua require("thordog.functions").toggle_option("relativenumber")<cr>', "Relative" },
    l = { '<cmd>lua require("thordog.functions").toggle_option("cursorline")<cr>', "Cursorline" },
    s = { '<cmd>lua require("thordog.functions").toggle_option("spell")<cr>', "Spell" },
    t = { '<cmd>lua require("thordog.functions").toggle_tabline()<cr>', "Tabline" },
  ...
  l = {
    ...
    c = { "<cmd>lua require('thordog.lsp').server_capabilities()<cr>", "Get Capabilities" },
    ...
    t = { '<cmd>lua require("thordog.functions").toggle_diagnostics()<cr>', "Toggle Diagnostics" },
